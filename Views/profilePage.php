        ...
        <form action="../app/process.php" method="post" enctype="multipart/form-data">
            <div class="form-group text-center">
                <a href="#" id="imageAnchor">
                    <img id="imagePreview" src="https://via.placeholder.com/150" alt="Upload Image" class="img-thumbnail">
                </a>
                <input type="file" id="imageUpload" class="form-control-file" name="profileImage" style="display: none;">
            </div>
            <div class="form-group">
                <label for="aboutMe">Iets over mijzelf:</label>
                <textarea class="form-control" id="aboutMe" name="aboutMe" rows="3" placeholder="Schrijf iets over jezelf"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="whereFrom" name="whereFrom" placeholder="Vul in waar je vandaan komt">
            </div>
            <div class="form-group">
                <label for="hobbies">Wat is mijn favoriete kleur?:</label>
                <input type="text" class="form-control" id="favColour" name="favColour" placeholder="Vul je favoriete kleur in">
            </div>
            <div class="form-group">
                <label for="hobbies">Wat is mijn favoriete dier?</label>
                <input type="text" class="form-control" id="favAnimal" name="favAnimal" placeholder="Vul je favoriete dier in">
            </div>
            <div class="form-group">
                <label for="hobbies">Wat is mijn favoriete seizoen?:</label>
                <input type="text" class="form-control" id="favSeason" name="favSeason" placeholder="Vul je favoriete seizoen in">
            </div>
            <div class="form-group">
                <label for="hobbies">Wat is mijn sterrenbeeld?:</label>
                <input type="text" class="form-control" id="starsign" name="starsign" placeholder="Vul je sterrenbeeld in">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="occupation" name="occupation" placeholder="Vul je dagbesteding in">
            </div>
            <div class="form-group">
                <label for="hobbies">Mijn green flags?:</label>
                <input type="text" class="form-control" id="greenFlag" name="greenFlag" placeholder="Vul je green flags in">
            </div>
            <div class="form-group">
